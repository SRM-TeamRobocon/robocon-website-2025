            ...
            >
                ...
                <div className="flex items-center justify-between gap-2 px-4 h-16 border-b border-white/10 shrink-0">
                    <Link href="/dashboard" className="flex items-center gap-3 min-w-0" onClick={onCloseMobile}>
                        <Image src="/LOGO.png" alt="Logo" width={32} height={32} unoptimized className="shrink-0" />
                        {!collapsed && (
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <Link
                                ...
                                className={[
                                    "group relative flex items-center gap-3 px-3 py-2.5 text-sm font-medium transition-all",
                            ...
                            >
                                {active && (
                                    <span className="absolute left-0 top-1/2 -translate-y-1/2 h-5 w-[3px] bg-red" />
                                )}
                ...
                <div className="hidden lg:flex border-t border-white/10 p-3">
                    <button
                        ...
                        className="flex w-full items-center justify-center gap-2 py-2 text-xs font-semibold text-gray-400 hover:text-white hover:bg-white/5 transition-colors"
                    >
