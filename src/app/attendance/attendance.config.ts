...
export const ATTENDANCE_MEMBERS: AttendanceMember[] = [
  ...
  { uid: "F94A9894", name: "Vrashni", domain: "SEISED" },
  { uid: "9EE14AB", name: "Niranjana", domain: "SEISED" },
  { uid: "A918A994", name: "Sangamithraa", domain: "SAMBED" },
  { uid: "29A6C09D", name: "Shaziya", domain: "SEISED" },
  ...
  { uid: "697713AB", name: "Bhaskar", domain: "SEISED" },
  { uid: "29EBC39D", name: "Karthik", domain: "SEISED" },
  { uid: "C98E23AB", name: "Rajat", domain: "SPACED" },
  { uid: "29781BAB", name: "Nitiraj", domain: "MCSOD" },
  { uid: "29908754", name: "Nilesh", domain: "SEISED" },
  { uid: "E9689054", name: "Mohamed Abdullah", domain: "SEISED" },
  { uid: "4929BD9D", name: "Daksh", domain: "SPACED" },
  { uid: "29D35E61", name: "Tanisha", domain: "SAMBED" },
  { uid: "D92E9994", name: "Vineet", domain: "SEISED" },
  { uid: "D9CCBB9D", name: "Keerthana", domain: "SAMBED" },
  { uid: "79F28654", name: "Samparna", domain: "SAMBED" },
  { uid: "D94419AB", name: "Bhargave", domain: "SEISED" },
  ...
  { uid: "C9C89F94", name: "Devdath", domain: "SEISED" },
  ...
  { uid: "99A06661", name: "Agamjot Kaur", domain: "SEISED" },
];
