...
const LOGIN_CARD_CLIP = "polygon(0 0,100% 0,100% 97%,97% 100%,0 100%)";
    ...
    return (
        <div className="min-h-[100dvh] flex items-center justify-center bg-white p-5">
            <div className="w-full max-w-md">
                ...
                <div className="w-full bg-black p-[2px]" style={{ clipPath: LOGIN_CARD_CLIP }}>
                    <div className="h-full w-full bg-white p-8" style={{ clipPath: LOGIN_CARD_CLIP }}>
