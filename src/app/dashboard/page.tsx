...
const TIMETABLE_ACTION: QuickAction = {
    ...
    icon: CalendarClock,
    badge: "Everyone",
    accent: "from-cyan-600/20 via-cyan-900/20 to-gray-900 border-cyan-500/30 hover:shadow-[0_0_30px_rgba(6,182,212,0.2)]",
...
const BLOG_ACTION: QuickAction = {
    ...
    icon: Newspaper,
    badge: "Everyone",
    accent: "from-amber-600/20 via-amber-900/20 to-gray-900 border-amber-500/30 hover:shadow-[0_0_30px_rgba(245,158,11,0.2)]",
...
const WRITE_BLOG_ACTION: QuickAction = {
    ...
    icon: PenSquare,
    badge: "Everyone",
    accent: "from-purple-600/20 via-purple-900/20 to-gray-900 border-purple-500/30 hover:shadow-[0_0_30px_rgba(168,85,247,0.2)]",
