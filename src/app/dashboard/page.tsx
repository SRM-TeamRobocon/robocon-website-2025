...
const CONTENT_ACTION: QuickAction = {
    ...
    icon: Globe2,
    badge: "Supabase CMS",
    accent: "border border-white/10 hover:border-red/50 hover:shadow-[0_0_30px_rgba(220,38,38,0.18)]",
...
const TIMETABLE_ACTION: QuickAction = {
    ...
    icon: CalendarClock,
    badge: "Everyone",
    accent: "border border-cyan-500/30 hover:shadow-[0_0_30px_rgba(6,182,212,0.2)]",
...
const APPROVALS_ACTION: QuickAction = {
    ...
    icon: ClipboardCheck,
    badge: "Lead Only",
    accent: "border border-blue-500/30 hover:shadow-[0_0_30px_rgba(59,130,246,0.2)]",
...
const PROPOSE_ACTION: QuickAction = {
    ...
    accent: "border border-emerald-500/30 hover:shadow-[0_0_30px_rgba(16,185,129,0.2)]",
...
const ATTENDANCE_ACTION: QuickAction = {
    ...
    icon: Radio,
    badge: "Live",
    accent: "border border-rose-500/30 hover:shadow-[0_0_30px_rgba(244,63,94,0.2)]",
    ...
    return (
        <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
            {cards.map((card) => {
                const body = (
                    <div
                        className="relative h-full border border-white/10 bg-black p-4 transition hover:border-white/20 sm:p-5"
                    >
    ...
    return (
        <div className="grid gap-5 md:grid-cols-2">
            {actions.map((action, i) => {
                ...
                const card = (
                    <div
                        className={`relative flex h-full flex-col bg-black p-6 sm:p-7 ${action.accent} ${
...
export default function AdminDashboard() {
            ...
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
                    {[0, 1, 2, 3].map((i) => (
                        <div
                            key={i}
                            className="relative border border-white/10 bg-black p-4 sm:p-5"
                        >
                ...
                <div className="grid gap-5 md:grid-cols-2">
                    {[0, 1, 2, 3].map((i) => (
                        <div
                            key={i}
                            className="relative h-52 animate-pulse border border-white/10 bg-black"
                        />
                    ))}
                </div>
                {!loading && !role && (
                    <div
                        className="relative border border-red bg-black p-5 text-sm text-gray-200"
                    >
    ...
    if (role === "member") {
        ...
        return (
            <div className="space-y-8">
                ...
                <ActionGrid actions={[RECRUITMENTS_ACTION, PROFILE_ACTION, ATTENDANCE_ACTION, PROPOSE_ACTION, BLOG_ACTION, SUBMISSIONS_ACTION, TIMETABLE_ACTION]} />
            </div>
        );
    }
    ...
    const staffActions =
        role === "lead" || role === "admin"
            ? [RECRUITMENTS_ACTION, CONTENT_ACTION, APPROVALS_ACTION, TIMETABLE_ACTION, ATTENDANCE_ACTION, BLOG_ACTION]
            : [RECRUITMENTS_ACTION, CONTENT_ACTION, TIMETABLE_ACTION, ATTENDANCE_ACTION, BLOG_ACTION];
