            ...
            {domains.map((d) => {
                ...
                return (
                    <span
                        ...
                        className={`inline-flex items-center gap-1 rounded-md px-2 py-0.5 text-xs font-medium ring-1 ring-inset whitespace-nowrap ${
                            attended
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <a
                    href={exportHref}
                    className="inline-flex items-center gap-1.5 rounded-lg bg-white/10 px-4 py-2 text-sm font-semibold text-white hover:bg-white/20 transition self-start sm:self-auto"
                >
                                                        ...
                                                        {canManageRecruits ? (
                                                            <>
                                                                <button
                                                                    ...
                                                                    title={`Edit ${r.name}`}
                                                                    className="inline-flex items-center gap-1.5 rounded-lg bg-white/10 px-2.5 py-1.5 text-xs font-semibold text-gray-300 ring-1 ring-inset ring-white/10 transition hover:bg-white/20 hover:text-white"
                                                                >
                                                                ...
                                                                <button
                                                                    ...
                                                                    title={`Delete ${r.name}`}
                                                                    className="inline-flex items-center gap-1.5 rounded-lg bg-red-500/10 px-2.5 py-1.5 text-xs font-semibold text-red-400 ring-1 ring-inset ring-red-500/30 transition hover:bg-red-500/25 disabled:opacity-40"
                                                                >
...
function EditRecruitModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
            <div className="w-full max-w-lg rounded-2xl border border-white/10 bg-gray-950 p-6 max-h-[90vh] overflow-y-auto">
                ...
                <div className="space-y-3">
                    ...
                    <label className="flex items-center gap-2 text-sm text-gray-300 pt-1">
                        <input
                            ...
                            className="rounded border-white/20 bg-white/5 text-red focus:ring-red"
                        />
                        Hosteller
                    </label>
                ...
                <div className="mt-6 flex justify-end gap-3">
                    <button
                        onClick={onClose}
                        disabled={saving}
                        className="rounded-lg px-4 py-2 text-sm font-semibold text-gray-400 hover:text-white transition disabled:opacity-40"
                    >
                        Cancel
                    </button>
                    <button
                        onClick={save}
                        disabled={saving}
                        className="rounded-lg bg-red px-4 py-2 text-sm font-semibold text-white hover:bg-red/90 transition disabled:opacity-40"
                    >
